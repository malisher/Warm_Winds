...
class Image_Stitching():
    ...
    def create_mask(self, img1, img2, version):
        ...
        self.smoothing_window_size = min(int(img1.shape[1] * 0.2), 800)

        offset = int(self.smoothing_window_size / 2)
        barrier = width_img1 - offset

        if barrier - offset < 0 or barrier + offset > width_img1:
            raise ValueError("Invalid barrier or offset values")
