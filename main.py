...
def parse_opt():
    ...
    parser.add_argument('--brands_path', default='data/792_annotations/filtered.xlsx', help='Path to filtered brands excel file')
...
if __name__ == '__main__':
    ...
    processed_images_data, cover_all = process_images(images_data, args.brands_path, args.data_folder)
